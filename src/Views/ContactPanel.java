...
public class ContactPanel extends JPanel{
    ...
    private String messageColor = "#44d794";
    ...
    private ContactPanel(){
        ...
        this.setPreferredSize(new Dimension(MainFrame.getFrame_Main().getWidth() - 10, MainFrame.getFrame_Main().getHeight() / 7));
...
//İŞLEM YÖNTEMLERİ:
    public void showMessage(String messageText, String messageType){
        ...
        if(strMessageColor != null)
            this.messageColor = strMessageColor;
        else
...
//ERİŞİM YÖNTEMLERİ:
    ...
    public HashMap<String, String> getMessageTypesAndColor() {
        if(messageTypesAndColor == null){
            ...
            messageTypesAndColor.put("Standard", "#e1625e");
